          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            delay: 0.4
              ...
              <div className="relative w-full max-w-md mx-auto">
                ...
                <img alt="Brandae App Demo" src="/lovable-uploads/b7b83b2d-2567-4919-a07d-da4094321086.png" className="relative z-10 w-full h-auto rounded-3xl shadow-xl border border-brandae-green/20 object-contain" />
              </div>
