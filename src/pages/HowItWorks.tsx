...
export default function HowItWorks() {
  ...
  return <div className="min-h-screen bg-brandae-dark text-white">
      <SEO title="How It Works - Brandae Multi-Vendor Platform" description="Learn how Brandae's multi-vendor e-commerce marketplace with integrated booking system works. From seller registration to customer satisfaction." keywords="how it works, multi-vendor platform, booking system, e-commerce marketplace, seller registration, customer experience" />
      <Navbar />
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24 bg-brandae-gray/20">
        <div className="container mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {platformStats.map((stat, index) => <motion.div key={stat.label} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            delay: index * 0.1
              ...
              duration: 0.3
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <motion.div className="text-brandae-green" whileHover={{
                  rotate: 360
                }} transition={{
                  duration: 0.5
                }}>
                ...
                {index < steps.length - 1 && index % 3 !== 2 && <div className="hidden lg:block absolute top-1/2 -right-4 transform -translate-y-1/2">
                    <motion.div animate={{
                x: [0, 5, 0]
              }} transition={{
                duration: 2,
      ...
      <section className="py-20 px-6 md:px-12 lg:px-24">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => <FeatureCard key={feature.title} title={feature.title} description={feature.description} icon={feature.icon} delay={index} className="bg-brandae-dark/50" />)}
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            duration: 0.6
              ...
              <div className="space-y-4">
                {["Unified platform for products and services", "Integrated payment and delivery systems", "Real-time booking and inventory management", "Multi-vendor marketplace capabilities", "Customer interaction and review systems"].map((benefit, index) => <motion.div key={index} initial={{
                opacity: 0,
                x: -20
              }} whileInView={{
                opacity: 1,
