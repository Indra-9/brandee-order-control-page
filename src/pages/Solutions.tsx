...
export default function Solutions() {
  const solutions = [{
    ...
    features: ["Individual seller dashboards", "Custom storefront themes", "Independent inventory management", "Seller analytics and reporting", "Commission management"]
  }, {
    ...
    features: ["Real-time availability tracking", "Automated booking confirmations", "Calendar synchronization", "Service scheduling tools", "Customer reminder system"]
  }, {
    ...
    features: ["Unified customer profiles", "Review and rating system", "Live chat support", "Loyalty programs", "Personalized recommendations"]
  }, {
    ...
    features: ["Real-time tracking", "Route optimization", "Delivery partner network", "Automated dispatch", "Customer notifications"]
  }, {
    title: "Payment Processing",
    description: "Secure, flexible payment solutions supporting multiple methods and automatic vendor payouts.",
    icon: <CreditCard className="w-12 h-12" />,
    features: ["Multiple payment methods", "Automatic split payments", "Fraud protection", "Recurring billing", "Financial reporting"]
  }, {
    title: "Analytics & Insights",
    description: "Comprehensive data analytics providing actionable insights for vendors and platform administrators.",
    icon: <BarChart3 className="w-12 h-12" />,
    features: ["Sales performance tracking", "Customer behavior analysis", "Revenue forecasting", "Inventory optimization", "Market trend insights"]
  }];
  const industries = [{
  ...
  return <div className="min-h-screen bg-brandae-dark text-white">
      <SEO title="Solutions - Brandae Multi-Vendor E-commerce Platform" description="Discover comprehensive solutions for multi-vendor marketplaces with integrated booking systems. Perfect for restaurants, beauty salons, retail stores, and service providers." keywords="multi-vendor marketplace, booking system, e-commerce solutions, restaurant ordering, beauty appointments, retail services" />
      <Navbar />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            delay: index * 0.1
                ...
                <ul className="space-y-2">
                  {solution.features.map((feature, featureIndex) => <li key={featureIndex} className="flex items-center gap-2 text-sm text-gray-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            delay: index * 0.1
                ...
                <div className="grid grid-cols-2 gap-4">
                  {industry.benefits.map((benefit, benefitIndex) => <div key={benefitIndex} className="flex items-center gap-2">
        ...
        <div className="container mx-auto">
          ...
          duration: 0.6
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              scale: 0.95
            }} className="px-8 py-4 font-semibold flex items-center gap-2 justify-center rounded bg-lime-400 hover:bg-lime-300 text-slate-900">
                Start Free Trial
