...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen bg-brandae-dark text-white">
      <SEO 
        title="Brandae Blog - Restaurant Technology & Business Growth Tips" 
        description="Expert insights, guides, and strategies for restaurant owners to grow their business with zero-commission ordering platforms and customer data ownership." 
        keywords="restaurant blog, food delivery tips, restaurant technology, customer retention, online ordering" 
      />
      ...
      {/* Category Filter */}
      {categories.length > 1 && (
        <section className="md:px-12 lg:px-24 mb-12 px-0">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input 
                ...
                className="flex-1 px-4 py-3 bg-brandae-gray border border-brandae-green/30 rounded-lg focus:outline-none focus:border-brandae-green text-white" 
              />
