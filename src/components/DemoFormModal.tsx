    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[100] flex items-start justify-center pt-8 md:pt-12 lg:pt-16 px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 overflow-y-auto"
        >
          {/* Backdrop */}
          <motion.div
            initial={{ opacity: 0 }}
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-6xl min-h-[80vh] max-h-[90vh] mt-4 md:mt-6 lg:mt-8 mb-4 md:mb-6 lg:mb-8 bg-gradient-to-br from-brandae-gray to-brandae-dark border border-brandae-green/20 rounded-3xl shadow-2xl overflow-hidden"
          >
            {/* Close button */}
            <motion.button
              onClick={handleClose}
            ...
            <div className="flex flex-col lg:flex-row min-h-full">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.3 }}
                className="flex-1 w-full lg:w-1/2 p-6 md:p-8 lg:p-12 flex flex-col justify-start relative overflow-y-auto z-30 lg:z-20"
              >
                {/* Mobile header */}
